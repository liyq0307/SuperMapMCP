...
__all__ = ['recordset_to_df', 'datasetvector_to_df', 'df_to_datasetvector',
    ...
    if nr is not None:
        if nr.ndim == 2:
            ...
            try:
                ...
                print(
                    'The source dataset has multiple bands and needs to be output as xarray.DataArray, please install '
                    'xarray before read data')
                raise e
        else:
            return None
    else:
...
def df_or_xarray_to_datasetraster(data, x_resolution, y_resolution, output, x_start=0, y_start=0,
    ...
    if isinstance(data, pandas.DataFrame):
        return numpy_array_to_datasetraster(data.values, x_resolution, y_resolution, output, x_start, y_start,
    ...
    try:
        ...
        return numpy_array_to_datasetraster(values, x_resolution, y_resolution, output, x_start, y_start,
                                            out_dataset_name, no_value, origin_is_left_up, as_grid)
    except ImportError as e:
