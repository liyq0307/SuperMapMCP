...
multilayer_overlay = supermap.multilayer_overlay
create_random_points = supermap.create_random_points
regularize_building_footprint = supermap.regularize_building_footprint
tabulate_area = supermap.tabulate_area
auto_compute_project_points = supermap.auto_compute_project_points
compute_natural_breaks = supermap.compute_natural_breaks
erase_and_replace_raster = supermap.erase_and_replace_raster
MCECellularAutomata = supermap.MCECellularAutomata
MCECellularAutomataParameter = supermap.MCECellularAutomataParameter
integrate = supermap.integrate
GTWR = supermap.GTWR
snap_pour_point = supermap.snap_pour_point

TopologicalSchemaOrientation = supermap.TopologicalSchemaOrientation
NetworkEdge = supermap.NetworkEdge
NetworkNode = supermap.NetworkNode
TopologicalHierarchicalSchema = supermap.TopologicalHierarchicalSchema
TopologicalTreeSchema = supermap.TopologicalTreeSchema
TopologicalOrthogonalSchema = supermap.TopologicalOrthogonalSchema
build_topological_schema = supermap.build_topological_schema

_sa = ['create_buffer', 'overlay', 'multilayer_overlay', 'create_random_points', 'regularize_building_footprint',
       'tabulate_area', 'auto_compute_project_points', 'compute_natural_breaks', 'erase_and_replace_raster',
       'dissolve', 'aggregate_points', 'smooth_vector', 'resample_vector',
       ...
       'compute_range_distance', 'integrate', 'eliminate', 'eliminate_specified_regions', 'edge_match',
       ...
       'ANNParameter', 'MCECellularAutomata', 'MCECellularAutomataParameter']

_topo = ['ProcessingOptions', 'topology_processing', 'topology_build_regions', 'pickup_border', 'PreprocessOptions',
         'preprocess', 'topology_validate', 'split_lines_by_regions', 'integrate']

_ss = ['measure_central_element', 'measure_directional', 'measure_linear_directional_mean', 'measure_mean_center',
       ...
       'spa_estimation', 'bshade_estimation', 'bshade_sampling',
       'BShadeSampleNumberMethod', 'BShadeEstimateMethod', 'BShadeSamplingParameter',
       'BShadeSamplingResult', 'BShadeEstimationResult']

_terrain = ['basin', 'build_quad_mesh', 'fill_sink', 'flow_accumulation', 'flow_direction',
            'flow_length', 'stream_order', 'stream_to_line', 'stream_link', 'watershed', 'pour_points',
            'snap_pour_point']

_na = ['WeightFieldInfo', 'PathAnalystSetting', 'SSCPathAnalystSetting', 'TransportationPathAnalystSetting',
...
_na3d = ['NetworkSplitMode3D', 'build_network_dataset_known_relation_3d', 'build_facility_network_directions_3d',
         'build_network_dataset_3d', 'FacilityAnalystResult3D', 'FacilityAnalystSetting3D',
         'FacilityAnalyst3D', 'BurstAnalystResult3D', 'TransportationAnalyst3D', 'TransportationAnalystResult3D',
         'TransportationAnalystParameter3D', 'TransportationAnalystSetting3D']

_am = ['build_address_indices', 'AddressItem', 'AddressSearch']

_schema = ['TopologicalSchemaOrientation', 'NetworkEdge', 'NetworkNode',
