...
from iobjectspy._jsuperpy.data import (DatasetVector,
                                       Point2D,
                                       Geometry,
                                       Rectangle,
                                       GeoLine,
...
from iobjectspy._jsuperpy.data._util import (get_input_dataset,
                                             ...
                                             to_java_geoline_array,
                                             to_java_datasetvector_array,
                                             to_java_point2ds,
                                             java_point2ds_to_list)
from iobjectspy._jsuperpy.enums import (JEnum, DatasetType, FieldSign)

from iobjectspy._jsuperpy._utils import (to_java_int_array,
                                         to_java_double_array,
                                         datetime_to_java_date,
                                         to_java_string_array,
                                         split_input_int_list_from_str,
                                         ...
                                         java_array_to_list,
                                         parse_datetime,
                                         split_input_float_list_from_str,
                                         to_java_array)
from iobjectspy._jsuperpy._logger import log_error
from iobjectspy._jsuperpy.data._jvm import JVMBase

__all__ = ['WeightFieldInfo', 'PathAnalystSetting', 'SSCPathAnalystSetting', 'TransportationPathAnalystSetting',
           'TransportationAnalystSetting', 'PathInfo', 'PathInfoItem', 'PathGuide', 'PathGuideItem', 'SSCPathAnalyst',
           'SSCCompilerParameter',
           'TrackPoint', 'TrajectoryPreprocessing', 'TransportationAnalystParameter', 'TransportationAnalyst',
           'TransportationAnalystResult', 'MapMatching', 'MapMatchingResult', 'MapMatchingLikelyResult',
           'TrajectoryPreprocessingResult', 'split_track', 'build_facility_network_directions',
           'build_network_dataset', 'fix_ring_edge_network_errors', 'build_facility_network_hierarchies',
           'build_network_dataset_known_relation',
           'append_to_network_dataset', 'validate_network_dataset', 'compile_ssc_data',
           'AllocationDemandType', 'AllocationAnalystResult', 'BurstAnalystResult', 'DemandPointInfo',
           'DirectionType', 'VRPAnalystType', 'VRPDirectionType', 'VRPAnalystParameter', 'VRPAnalystResult',
           'FacilityAnalyst', 'TerminalPoint', 'FacilityAnalystResult', 'FacilityAnalystSetting', 'SideType',
           'TurnType', 'ServiceAreaType', 'VehicleInfo', 'NetworkDatasetErrors', 'GroupAnalystResult',
           'GroupAnalystResultItem', 'SupplyCenterType', 'SupplyCenter', 'SupplyResult', 'DemandResult',
           'LocationAnalystResult', 'RouteType', 'NetworkSplitMode']
...
class PathAnalystSetting:
    """最佳路径分析环境设置，该类抽象基类，用户可以选择使用 :py:class:`SSCPathAnalystSetting` 或 :py:class:`TransportationPathAnalystSetting` """
...
class TransportationPathAnalystSetting(PathAnalystSetting):
    ...
    def __init__(self, network_dataset=None):
        ...
        # self._turn_dataset = None
        # self._turn_node_id = None
        # self._turn_f_edge_id_field = None
        # self._turn_t_edge_id_field = None
        # self._turn_weight_fields = None
        self._edge_filter = None
        self._bounds = None
        # self._network_model_file = None
    ...
    def set_weight_fields(self, value):
        ...
        if isinstance(value, WeightFieldInfo):
    ...
    #     """str: 转向表数据集"""
    #     return self._turn_dataset
    #
    # def set_turn_dataset(self, value):
    #     """
    #     设置转向表数据集
    #
    ...
    #     :rtype: TransportationPathAnalystSetting
    #     """
    #     self._turn_dataset = value
    #     return self
    #
    # @property
    # def turn_node_id(self):
    #     """str: 转向结点 ID 的字段"""
    #     return self._turn_node_id
    #
    # def set_turn_node_id(self, value):
    #     """
    #     设置转向结点 ID 的字段
    #
    #     :param str value:
    ...
    #     :rtype: TransportationPathAnalystSetting
    #     """
    #     self._turn_node_id = value
    #     return self
    #
    # @property
    # def turn_f_edge_id_field(self):
    #     """str: 转向起始弧段 ID 的字段"""
    #     return self._turn_f_edge_id_field
    #
    # def set_turn_f_edge_id_field(self, value):
    #     """
    #     设置转向起始弧段 ID 的字段
    #
    #     :param value: 转向起始弧段 ID 的字段
    #     :return: self
    #     :rtype: TransportationPathAnalystSetting
    #     """
    #     self._turn_f_edge_id_field = value
    #     return self
    #
    # @property
    # def turn_t_edge_id_field(self):
    #     """str: 转向终止弧段 ID 的字段"""
    #     return self._turn_t_edge_id_field
    #
    # def set_turn_t_edge_id_field(self, value):
    #     """
    #     设置转向终止弧段 ID 的字段
    #
    #     :param str value: 转向终止弧段 ID 的字段
    #     :return: self
    #     :rtype: TransportationPathAnalystSetting
    #     """
    #     self._turn_t_edge_id_field = value
    #     return self
    #
    # @property
    # def turn_weight_fields(self):
    #     """list[str]: 转向权值字段集合"""
    #     return self._turn_weight_fields
    #
    # def set_turn_weight_fields(self, value):
    #     """
    #     设置转向权值字段集合
    #
    #     :param value: 转向权值字段集合
    #     :return: self
    #     :rtype: TransportationPathAnalystSetting
    #     """
    #     self._turn_weight_fields = split_input_list_from_str(value)
    #     return self
    ...
    #
    # def set_network_model_file(self, value):
    #     if value is not None:
    #         self._network_model_file = str(value)
    #     return self
    #
    # @property
    # def network_model_file(self):
    #     """str: """
    #     return self._network_model_file
    #
    # @classmethod
    # def from_model_file(cls, mode_file, network_dt):
    #     network_dt = get_input_dataset(network_dt)
    #     setting = cls(network_dt)
    #     setting.set_network_model_file(mode_file)
    #     return setting
    ...
    def _java_transportation_analyst_setting(self):
        ...
        if self.barrier_node_ids is not None:
            java_object.setBarrierNodes(
                to_java_int_array(split_input_int_list_from_str(self.barrier_node_ids)))
        if self.barrier_edge_ids is not None:
            java_object.setBarrierEdges(
                to_java_int_array(split_input_int_list_from_str(self.barrier_edge_ids)))
        if self.rule_field is not None:
            java_object.setRuleField(str(self.rule_field))

        if self.ft_single_way_rule_values is not None:
            java_object.setFTSingleWayRuleValues(
                to_java_string_array(split_input_list_from_str(self.ft_single_way_rule_values)))

        if self.tf_single_way_rule_values is not None:
            java_object.setTFSingleWayRuleValues(
                to_java_string_array(split_input_list_from_str(self.tf_single_way_rule_values)))

        if self.prohibited_way_rule_values is not None:
            java_object.setProhibitedWayRuleValues(
                to_java_string_array(split_input_list_from_str(self.prohibited_way_rule_values)))
        ...
        #     java_object.setTurnDataset(oj(self.turn_dataset))
        #
        # if self.turn_node_id is not None:
        #     java_object.setTurnNodeID(str(self.turn_node_id))
        #
        # if self.turn_f_edge_id_field is not None:
        #     java_object.setTurnFEdgeIDField(self.turn_f_edge_id_field)
        #
        # if self.turn_t_edge_id_field is not None:
        #     java_object.setTurnTEdgeIDField(self.turn_t_edge_id_field)
        #
        # if self.turn_weight_fields is not None:
        #     java_object.setTurnWeightFields(split_input_list_from_str(self.turn_weight_fields))
...
class TransportationAnalystSetting(TransportationPathAnalystSetting):
    ...
    def __init__(self, network_dataset=None):
        ...
        :type network_dataset: DatasetVector or str
        """
        TransportationPathAnalystSetting.__init__(self, network_dataset)
...
class PathInfo:
    ...
    def __str__(self):
        if self._items:
            ...
            navigation_infos = [navigation_info]
            ...
            for index, item in enumerate(self._items):
                ...
                if index == len(self._items) - 1 and len(self._items) > 1:
                    ...
                    if item.length > 0:
                        next_route_name = self._items[index + 1].route_name if self._items[
                            index + 1].route_name else '匿名道路'

                        if next_route_name == 'PathPoint':
                            next_route_name = '匿名道路'

                        navigation_info = '沿着[{}], 行驶{}, 然后{}进入[{}]'.format(route_name, round(item.length, 2),
                                                                            PathInfo._turn_type_str(
                                                                                item.direction_to_swerve),
                                                                            next_route_name)
                    else:
...
class SSCPathAnalyst(JVMBase):
    """基于 SSC 文件的路径分析类。用户可以通过 :py:meth:`compile_ssc_data` 编译 ssc 文件。通常，使用 SSC 文件的路径分析性能要好于基于
     网络数据集的交通网络路径分析性能。"""
...
class TrackPoint:
    ...
    @property
    def _jobject(self):
        java_object = get_jvm().com.supermap.analyst.networkanalyst.TrackPoint(oj(self.point),
                                                                               datetime_to_java_date(self.time))
        java_object.setKey(int(self.key))
        return java_object

    @staticmethod
    def _from_java_object(java_object):
        return TrackPoint(Point2D._from_java_object(java_object.getPoint()),
                          java_date_to_datetime(java_object.getTime()),
                          java_object.getKey())
...
class MapMatching(JVMBase):
    ...
    def batch_match_dataset(self, source_dataset, id_field, time_field, split_time_milliseconds,
                            out_data=None, out_dataset_name=None, result_track_index_field='TrackIndex'):
        """
        对数据集进行地图匹配，结果保存为点数据
        ...
        if not result_track_index_field:
            result_track_index_field = 'TrackIndex'

        java_result = self._jobject.batchMatch(oj(source_dataset), id_field, str(time_field),
                                               float(split_time_milliseconds),
                                               oj(out_datasource), str(dest_name), str(result_track_index_field))
...
def split_track(track_points, split_time_milliseconds):
    ...
    java_result = get_jvm().com.supermap.analyst.networkanalyst.TrajectoryPreprocessing.splitTrack(
        java_points, float(split_time_milliseconds))
    if java_result is not None:
        result = []
...
class TrajectoryPreprocessing(JVMBase):
    ...
    def rectify_dataset(self, source_dataset, id_field, time_field, split_time_milliseconds,
                        out_data=None, out_dataset_name=None, result_track_index_field='TrackIndex'):
        """
        ...
        java_result = self._jobject.rectify(oj(source_dataset), id_field, str(time_field),
                                            float(split_time_milliseconds),
                                            oj(out_datasource), str(dest_name), str(result_track_index_field))
        if java_result is not None:
            return out_datasource[dest_name]
...
class SSCCompilerParameter:
    ...
    #     :param str value:
    #     :return: self
    #     :rtype: GeneralPathAnalystSetting
    #     """
    #     self._turn_node_id = value
    #     return self
    #
    ...
    try:
        ...
        if progress is not None and safe_start_callback_server():
            try:
                ...
                compiler.addSteppedListener(listener)
        ...
        if listener is not None:
            try:
                compiler.removeSteppedListener(listener)
...
def build_network_dataset(lines, points=None, split_mode='NO_SPLIT', tolerance=0.0, line_saved_fields=None,
                          point_saved_fields=None, out_data=None, out_dataset_name=None, progress=None):
    """
    ...
    if points is not None:
        if isinstance(points, (list, tuple)):
            point_dts = list(
                filter(lambda dt: dt.type is DatasetType.POINT, list(get_input_dataset(item) for item in points)))
        else:
            point_dts = [get_input_dataset(points)]
    else:
        point_dts = None
    ...
    try:
        ...
        java_result = network_builder_func(java_line_dts, java_point_dts,
                                           to_java_string_array(split_input_list_from_str(line_saved_fields)),
                                           to_java_string_array(split_input_list_from_str(point_saved_fields)),
                                           oj(out_datasource), str(dest_name),
                                           oj(NetworkSplitMode._make(split_mode, 'NO_SPLIT')),
                                           float(tolerance))
    except:
        import traceback
        log_error(traceback.format_exc())
...
def build_network_dataset_known_relation(line, point, edge_id_field, from_node_id_field, to_node_id_field,
                                         node_id_field, out_data=None, out_dataset_name=None, progress=None):
    """
    ...
    try:
        ...
        network_builder_func = get_jvm().com.supermap.analyst.networkanalyst.NetworkBuilder.buildNetwork
        java_result = network_builder_func(oj(source_line_dt), oj(source_point_dt),
                                           str(edge_id_field), str(from_node_id_field), str(to_node_id_field),
                                           str(node_id_field), oj(out_datasource), str(dest_name))
    except:
        import traceback
        log_error(traceback.format_exc())
        java_result = None
...
def append_to_network_dataset(network_dataset, appended_datasets, progress=None):
    ...
    * 注意:
    ...
    if not isinstance(appended_datasets, (list, tuple)):
        appended_datasets = [appended_datasets]

    datasets = list(filter(lambda dt: dt is not None and (dt.type is DatasetType.LINE or dt.type is DatasetType.REGION),
                           list(get_input_dataset(p) for p in appended_datasets)))
    if not datasets:
...
def build_facility_network_directions(network_dataset, source_ids, sink_ids, ft_weight_field='SmLength',
                                      tf_weight_field='SmLength', direction_field='Direction',
                                      node_type_field='NodeType', progress=None):
    """
    ...
    * 结点类型
    ...
    if not isinstance(network_dataset, DatasetVector):
        raise ValueError(
            'network_dataset required DatasetVector, but ' + str(type(network_dataset)))
    ...
    try:
        ...
        java_result = java_function(oj(facility_analyst_setting),
                                    to_java_int_array(split_input_int_list_from_str(source_ids)),
                                    to_java_int_array(split_input_int_list_from_str(sink_ids)),
                                    str('Length'),
                                    str(node_type_field))
    except:
        import traceback
...
def build_facility_network_hierarchies(network_dataset, source_ids, sink_ids, direction_field, is_loop_valid,
                                       ft_weight_field='SmLength', tf_weight_field='SmLength',
                                       hierarchy_field='Hierarchy', progress=None):
    """
...
# def create_turn_table(network_dt, query_parameter, out_data=None, out_dataset_name=None, progress=None):
#     """
#     创建转向表数据集。
#
#     在交通网络分析中，可以使用转向表存储完成转弯需要的花费。转弯是指从一个弧段经过中间结点抵达另外一个邻接弧段的过程。转弯耗费即完成转弯所需要的花费。
#
#     转向表是一个纯属性表数据集，每一条记录代表一个转弯，一般有起始弧段字段（FromEdgeID）、终止弧段字段（ToEdgeID）、结点标识字段
#     （NodeID）和转弯耗费字段（TurnCost）四个字段，这些字段与弧段、结点中的字段相关联，表中的每条记录表示一种通过路口的方式以及所
#     需要的耗费。转弯耗费通常是有方向性的，转弯的负耗费值一般为禁止转弯（不通行）。
#
#     例如，在对道路进行网络分析的时候，我们经常会遇到十字路口、三岔口等情况，可以通过转向耗费为转弯方式赋予权值，为如何转向提供一定的
#     参考。如某些道路车多或道路状况差，或转向该路段的红灯等待时间较长，花费就应较高一些，而某些道路不通行禁止转入等，可将花费设置为
#     负值。如下图所示，左面为一个十字路口的示意图，右面的表格为该十字路口所对应的转向表，转向表中记录了402结点所在的十字口处车辆的所
#     有转向方式（共16种）和转弯所需的耗费等信息。
#
#     .. image:: ../image/TurnDataset.png
#
#     * 注意:
#
#       使用该方法为网络数据集创建的转向表，其转弯花费（TurnCost 字段）均为 0。用户可根据应用的实际情况对转向表的权值进行修改。对于禁止通行的转弯需要设置权值为负数。
#
#
#     :param network_dt: 指定的网络数据集
#     :type network_dt: DatasetVector or str
#     :param query_parameter: 网络数据集结点数据集查询参数
#     :type query_parameter: QueryParameter
#     :param out_data: 保留结果转向表数据集的数据源对象
#     :type out_data: Datasource or DatasourceConnectionInfo or str
#     :param str out_dataset_name: 结果数据集名称
#     :param function progress: 进度信息处理函数，具体参考 :py:class:`.StepEvent`
#     :return: 结果转向表数据集
#     :rtype: DatasetVector
#     """
#     source_network = get_input_dataset(network_dt)
#     if not isinstance(source_network, DatasetVector):
#         raise ValueError('network_dt required DatasetVector, but is ' + str(type(source_network)))
#
#     if query_parameter is None:
#         query_parameter = QueryParameter()
#
#     if not isinstance(query_parameter, QueryParameter):
#         raise ValueError('query_parameter required QueryParameter, but is ' + str(type(query_parameter)))
#
#     if out_data is not None:
#         out_datasource = get_output_datasource(out_data)
#     else:
#         out_datasource = source_network.datasource
#     check_output_datasource(out_datasource)
#     if out_dataset_name is None:
#         dest_name = source_network.name + '_Turn'
#     else:
#         dest_name = out_dataset_name
#     dest_name = out_datasource.get_available_dataset_name(dest_name)
#
...
#                 try:
#                     listener = ProgressListener(progress, 'create_turn_table')
#                     get_jvm().com.supermap.analyst.networkanalyst.NetworkBuilder.addSteppedListener(listener)
#                 except Exception as e:
#                     close_callback_server()
#                     log_error(e)
#                     listener = None
#
#         createTurnTable = get_jvm().com.supermap.analyst.networkanalyst.NetworkBuilder.createTurnTable
#         java_result = createTurnTable(oj(source_network), oj(query_parameter), oj(out_datasource), str(dest_name))
#     except:
#         import traceback
#         log_error(traceback.format_exc())
#         java_result = False
...
class BurstAnalystResult:
    """爆管分析结果类。爆管分析结果返回关键设施点、普通设施点以及弧段。"""
...
class FacilityAnalyst(JVMBase):
    ...
    def burst_analyse(self, source_nodes, edge_or_node_id, is_uncertain_direction_valid=False, is_edge_id=True):
        ...
        java_result = func(to_java_int_array(source_nodes), int(edge_or_node_id),
                           parse_bool(is_uncertain_direction_valid))
        if java_result is not None:
    ...
    def find_critical_facilities_down(self, source_node_ids, edge_or_node_id, is_uncertain_direction_valid=False,
                                      is_edge_id=True):
        """
        ...
        java_result = func(to_java_int_array(source_node_ids), int(edge_or_node_id),
                           parse_bool(is_uncertain_direction_valid))
        if java_result is not None:
            return FacilityAnalystResult(java_result)
        return None

    def find_critical_facilities_up(self, source_node_ids, edge_or_node_id, is_uncertain_direction_valid=False,
                                    is_edge_id=True):
        """
        ...
        * 应用实例
        ...
        java_result = func(to_java_int_array(split_input_int_list_from_str(source_node_ids)), int(edge_or_node_id),
                           parse_bool(is_uncertain_direction_valid))
        if java_result is not None:
            return FacilityAnalystResult(java_result)
        return None
    ...
    def find_path_down(self, edge_or_node_id, weight_name=None, is_uncertain_direction_valid=False, is_edge_id=True):
        ...
        java_result = func(int(edge_or_node_id), str(weight_name) if weight_name is not None else 'Length',
                           parse_bool(is_uncertain_direction_valid))
        if java_result is not None:
            return FacilityAnalystResult(java_result)
        return None
    ...
    def find_path(self, start_id, end_id, weight_name=None, is_uncertain_direction_valid=False, is_edge_id=True):
        ...
        java_result = func(int(start_id), int(end_id), str(weight_name) if weight_name is not None else 'Length',
                           parse_bool(is_uncertain_direction_valid))
        if java_result is not None:
            return FacilityAnalystResult(java_result)
        return None
...
class TransportationAnalystParameter:
    ...
    # @property
    # def turn_weight_field(self):
    #     return self._turn_weight_field
    #
    # def set_turn_weight_field(self, field_name):
    #     self._turn_weight_field = field_name
    #     return self

    # @property
    # def u_cross(self):
    #     return self._u_cross
    #
    # def set_u_cross(self, value):
    #     if isinstance(value, (list, tuple)):
    #         items = []
    #         for item in value:
    #             int_values = split_input_int_list_from_str(item)
    #             if int_values is not None:
    #                 items.append(int_values)
    #         self._u_cross = items
    #     else:
    #         raise ValueError('value required list[list[int]]')
    ...
    def _jobject(self):
        ...
        # if self.turn_weight_field is not None:
        #     java_object.setTurnWeightField(str(self.turn_weight_field))
        return java_object
...
class ServiceAreaType(JEnum):
    ...
    @classmethod
    def _externals(cls):
        return {'simple': ServiceAreaType.SIMPLEAREA,
                'complex': ServiceAreaType.COMPLEXAREA}
...
class PathGuide:
    ...
    def _side_type_str(side_type):
        if side_type is SideType.LEFT:
            return '左侧'
        elif side_type is SideType.RIGHT:
            return '右侧'
        return ''
    ...
    def _turn_type_str(turn_type):
        if turn_type is TurnType.LEFT:
            return '左转弯'
        elif turn_type is TurnType.RIGHT:
            return '右转弯'
        elif turn_type is TurnType.AHEAD:
            return '向前直行'
        elif turn_type is TurnType.BACK:
            return '掉头行驶'
        return ''
                ...
                if guide_item.is_stop and guide_item.index != -1:
                    ...
                    if index != len(self._guide_items) - 1:
                        if guide_item.side_type is (SideType.RIGHT, SideType.LEFT):
                            guide_info = '到达[{}号路由点]，在道路{} {}'.format(stop_index,
                                                                      PathGuide._side_type_str(
                                                                          guide_item.side_type),
                                                                      round(guide_item.distance, 1))
                        else:
                        ...
                        if guide_item.side_type is (SideType.RIGHT, SideType.LEFT):
                            if index > 1:
                                if self._guide_items[index - 3].name:
                                    ...
                                    next_road_name = '匿名路段'
                                guide_info = '到达终点，在道路[{}]{} {}'.format(next_road_name,
                                                                        PathGuide._side_type_str(
                                                                            guide_item.side_type),
                                                                        round(guide_item.distance, 4))
                        else:
                            guide_info = '到达终点'
                    navigation_infos.append(guide_info)

                elif guide_item.is_edge and guide_item.node_edge_id != -1:
                        ...
                        if guide_next.index != -1:
                            if guide_next.turn_type is not TurnType.NONE:
                                if guide_next.turn_type is not TurnType.END:
                                    ...
                                    guide_info = '沿着[{}], 行走{}, {}进入[{}]'.format(road_name, weight,
                                                                                 PathGuide._turn_type_str(
                                                                                     guide_next.turn_type),
                                                                                 next_road_name)
                                else:
                                    guide_info = '沿着[{}], 行走{}'.format(road_name, weight)
                        else:
...
class TransportationAnalystResult:
    ...
    def __init__(self, java_object, index):
        ...
        if java_path_guides is not None and len(java_path_guides) > index:
            ...
            self._path_guides = PathGuide(list(
                PathGuideItem(java_path_guide_items.get(i)) for i in range(java_path_guide_items.getCount())))
        else:
...
class NetworkDatasetErrors:
    ...
    #     """"""
    #     return self._turn_errors


def validate_network_dataset(network_dataset, edge_id_field=None, f_node_id_field=None,
                             t_node_id_field=None, node_id_field=None):
    """
    ...
    if network_dataset.type is not DatasetType.NETWORK and network_dataset.type is not DatasetType.NETWORK3D:
...
def fix_ring_edge_network_errors(network_dataset, error_ids, edge_id_field=None, f_node_id_field=None,
                                 t_node_id_field=None, node_id_field=None):
    """
    ...
    if network_dataset.type is DatasetType.NETWORK3D:
        result = (get_jvm().com.supermap.realspace.networkanalyst.
                  NetworkBuilder3D.fixRingEdgeErrors(oj(network_dataset),
                                                     error_ids,
                                                     str(edge_id_field),
                                                     str(f_node_id_field),
                                                     str(t_node_id_field),
        ...
        result = (get_jvm().com.supermap.analyst.networkanalyst.
                  NetworkBuilder.fixRingEdgeErrors(oj(network_dataset),
                                                   error_ids,
                                                   str(edge_id_field),
                                                   str(f_node_id_field),
                                                   str(t_node_id_field),
...
class SupplyCenterType(JEnum):
    ...
    @classmethod
    def _externals(cls):
        return {'optional': SupplyCenterType.OPTIONALCENTER,
                'fixed': SupplyCenterType.FIXEDCENTER,
...
class AllocationAnalystResult:
    ...
    def parse(java_object, supply_centers):
        ...
        if len(java_nodes) == len(supply_centers) and len(java_edges) == len(supply_centers):
            ...
            for i in range(len(nodes)):
                ...
                results.append(
                    AllocationAnalystResult(item_nodes, item_edges, item_demands, item_routes, center_node_id))
            return results
        return None
...
class VRPAnalystType(JEnum):
    ...
    @classmethod
    def _externals(cls):
        return {'least': VRPAnalystType.LEASTCOST,
                'average': VRPAnalystType.AVERAGECOST,
...
class VRPAnalystParameter:
    ...
    #     return self._turn_weight_field
    #
    # def set_turn_weight_field(self, value):
    #     if value is not None:
    #         self._turn_weight_field = str(value)
    #     else:
    #         self._turn_weight_field = None
    #     return self
    ...
    def _jobject(self):
        ...
        # if self.turn_weight_field is not None:
        #     java_object.setTurnWeightField(self.turn_weight_field)
        if self.weight_name is not None:
...
class VehicleInfo:
    ...
    def _jobject(self):
        ...
        if self.se_node is not None and int(self.se_node) > 0:
...
class TransportationAnalyst(JVMBase):
    ...
    def update_edge_weight(self, edge_id, from_node_id, to_node_id, weight_name, weight):
        ...
        self._load_internal()
        if not weight_name:
            if self.analyst_setting.weight_fields:
                weight_name = self.analyst_setting.weight_fields[0].weight_name
            else:
                weight_name = 'Length'
        return self._jobject.updateEdgeWeight(int(edge_id), int(from_node_id), int(to_node_id), str(weight_name),
                                              float(weight))

    # def update_turn_weight(self, node_id, from_edge_id, to_edge_id, turn_weight_field, weight):
    #     self._load_internal()
    #     return self._jobject.updateTurnWeight(int(node_id), int(from_edge_id), int(to_edge_id), str(turn_weight_field),
    #                                           float(weight))
    ...
    def find_path(self, parameter, is_least_edges=False):
        ...
        :param parameter: 交通网络分析参数对象
        :type parameter: TransportationAnalystParameter or list[int] or list[Point2D]
        ...
        if isinstance(parameter, (list, tuple)):
            ...
            for item in parameter:
                if isinstance(item, int):
                    ...
                    item = Point2D.make(item)
                    if isinstance(item, Point2D):
                        points.append(item)
            parameter = TransportationAnalystParameter(). \
                set_edges_return(True). \
                set_routes_return(True). \
                set_nodes_return(True). \
                set_path_guides_return(True). \
                set_stop_indexes_return(True). \
                set_points(points). \
                set_nodes(nodes)
    ...
    def find_closest_facility(self, parameter, event_id_or_point, facility_count, is_from_event, max_weight):
        ...
        java_result = self._jobject.findClosestFacility(oj(parameter), event, int(facility_count),
                                                        parse_bool(is_from_event),
                                                        float(max_weight))
        if java_result is not None:
    ...
    def find_mtsp_path(self, parameter, center_nodes_or_points, is_least_total_cost=False):
        ...
        if not isinstance(parameter, TransportationAnalystParameter):
            raise ValueError('parameter required TransportationAnalystParameter, but ' + str(type(parameter)))
        self._load_internal()
        if isinstance(center_nodes_or_points, (list, tuple)) and center_nodes_or_points:
    ...
    def find_service_area(self, parameter, weights, is_from_center, is_center_mutually_exclusive=False,
                          service_area_type=ServiceAreaType.SIMPLEAREA):
        """
        服务区分析。
        ...
        java_result = self._jobject.findServiceArea(oj(parameter), to_java_double_array(weights),
                                                    parse_bool(is_from_center),
                                                    parse_bool(is_center_mutually_exclusive))
        if java_result is not None:
            count = len(java_result.getWeights())
    ...
    def allocate(self, supply_centers, demand_type=AllocationDemandType.BOTH,
                 is_connected=True, is_from_center=True, edge_demand_field='EdgeDemand',
                 node_demand_field='NodeDemand', weight_name=None):
        """
        资源分配分析。
        ...
        if not isinstance(supply_centers, (list, tuple)):
        ...
        # if turn_weight_field is not None:
        #     java_parameter.setTurnWeightField(str(turn_weight_field))
    ...
    def find_group(self, terminal_points, center_points, max_cost, max_load, weight_name=None,
                   barrier_nodes=None, barrier_edges=None, barrier_points=None, is_along_road=False):
        """
        分组分析。
        ...
        java_terminal_points = get_gateway().new_array(get_jvm().com.supermap.analyst.networkanalyst.GroupPointInfo,
                                                       len(terminal_points))
        ...
        java_result = self._jobject.findGroup(java_parameter, java_terminal_points, float(max_cost),
                                              float(max_load))
        if java_result is not None:
    ...
    def find_vrp(self, parameter, vehicles, center_nodes_or_points, demand_points):
        ...
        java_vehicles = get_gateway().new_array(get_jvm().com.supermap.analyst.networkanalyst.VehicleInfo,
                                                len(vehicles))
        ...
        if isinstance(center_nodes_or_points, (list, tuple)) and center_nodes_or_points:
            if isinstance(center_nodes_or_points[0], int):
                java_centers = get_gateway().new_array(
                    get_jvm().com.supermap.analyst.networkanalyst.CenterPointInfo,
                    len(center_nodes_or_points))
        ...
        java_demands = get_gateway().new_array(get_jvm().com.supermap.analyst.networkanalyst.DemandPointInfo,
                                               len(demand_points))
