...
class Color(tuple):
    ...
    def make(value):
        ...
        if isinstance(value, str):
            ...
            if isinstance(list_value, (list, tuple)) and len(list_value) >= 3:
...
class GeoStyle(JVMBase):
    ...
    def point_style(marker_id=0, marker_angle=0.0, marker_size=(4, 4), color=(0, 0, 0)):
        ...
        return GeoStyle().set_marker_symbol_id(marker_id).set_marker_angle(marker_angle).set_marker_size(
            marker_size[0], marker_size[1]).set_line_color(color)
