...
from ._util import (check_output_datasource,
                    get_input_dataset,
...
from .._utils import (oj,
                      ...
                      split_input_list_tuple_item_from_str)

__all__ = ['dataset_dim2_to_dim3', 'dataset_dim3_to_dim2', 'dataset_point_to_line', 'dataset_line_to_point',
...
def dataset_dim2_to_dim3(source, z_field_or_value, line_to_z_field=None, saved_fields=None, out_data=None,
    ...
    try:
        if isinstance(z_field_or_value, (int, float)):
            ...
            java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetDim2To3(oj(source_dt),
                                                                                         z_field_or_value,
                                                                                         saved_fields,
                                                                                         oj(out_datasource),
                                                                                         _outDatasetName)
...
def dataset_dim3_to_dim2(source, out_z_field='Z', saved_fields=None, out_data=None, out_dataset_name=None):
    ...
    saved_fields = split_input_list_from_str(saved_fields)
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetDim3To2(oj(source_dt),
                                                                                     out_z_field,
                                                                                     saved_fields,
                                                                                     oj(out_datasource),
                                                                                     _outDatasetName)
...
def dataset_point_to_line(source, group_fields=None, order_fields=None, field_stats=None, out_data=None,
                          out_dataset_name=None):
    """
    ...
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetPointToLine(oj(source_dt),
                                                                                         group_fields,
                                                                                         order_fields,
                                                                                         stat_fields,
                                                                                         stat_modes,
...
def dataset_line_to_point(source, mode='VERTEX', saved_fields=None, out_data=None, out_dataset_name=None):
    ...
    saved_fields = split_input_list_from_str(saved_fields)
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetLineToPoint(oj(source_dt),
                                                                                         oj(LineToPointMode._make(mode,
                                                                                                                  'VERTEX')),
                                                                                         saved_fields,
                                                                                         oj(out_datasource),
                                                                                         _outDatasetName)
...
def dataset_line_to_region(source, saved_fields=None, out_data=None, out_dataset_name=None):
    ...
    saved_fields = split_input_list_from_str(saved_fields)
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetLineToRegion(oj(source_dt),
                                                                                          saved_fields,
                                                                                          oj(out_datasource),
                                                                                          _outDatasetName)
    except:
...
def dataset_region_to_line(source, saved_fields=None, out_data=None, out_dataset_name=None):
    ...
    saved_fields = split_input_list_from_str(saved_fields)
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetRegionToLine(oj(source_dt),
                                                                                          saved_fields,
                                                                                          oj(out_datasource),
                                                                                          _outDatasetName)
    except:
...
def dataset_region_to_point(source, mode='INNER_POINT', saved_fields=None, out_data=None, out_dataset_name=None):
    ...
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetRegionToPoint(oj(source_dt),
                                                                                           oj(mode),
                                                                                           saved_fields,
                                                                                           oj(out_datasource),
                                                                                           _outDatasetName)
...
def dataset_field_to_text(source, field, saved_fields=None, out_data=None, out_dataset_name=None):
    ...
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetFieldToText(oj(source_dt),
                                                                                         field,
                                                                                         saved_fields,
                                                                                         oj(out_datasource),
                                                                                         _outDatasetName)
...
def dataset_text_to_field(source, out_field='Text'):
    ...
    if not isinstance(source_dt, DatasetVector):
        raise ValueError('source required DatasetVector, but is ' + str(type(source)))
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetTextToField(oj(source_dt),
                                                                                         out_field)
    except:
        import traceback
        log_error(traceback.format_exc())
...
def dataset_text_to_point(source, out_field='Text', saved_fields=None, out_data=None, out_dataset_name=None):
    ...
    saved_fields = split_input_list_from_str(saved_fields)
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetTextToPoint(oj(source_dt),
                                                                                         out_field,
                                                                                         saved_fields,
                                                                                         oj(out_datasource),
                                                                                         _outDatasetName)
...
def dataset_field_to_point(source, x_field, y_field, z_field=None, saved_fields=None, out_data=None,
                           out_dataset_name=None):
    """
    ...
    saved_fields = split_input_list_from_str(saved_fields)
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetFieldToPoint(oj(source_dt), x_field,
                                                                                          y_field,
                                                                                          z_field,
                                                                                          saved_fields,
                                                                                          oj(out_datasource),
...
def dataset_network_to_line(source, saved_fields=None, out_data=None, out_dataset_name=None):
    ...
    saved_fields = split_input_list_from_str(saved_fields)
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetNetworkToLine(oj(source_dt),
                                                                                           saved_fields,
                                                                                           oj(out_datasource),
                                                                                           _outDatasetName)
    except:
...
def dataset_network_to_point(source, saved_fields=None, out_data=None, out_dataset_name=None):
    ...
    saved_fields = split_input_list_from_str(saved_fields)
    try:
        java_result = get_jvm().com.supermap.jsuperpy.Converts.convertDatasetNetworkToPoint(oj(source_dt),
                                                                                            saved_fields,
                                                                                            oj(out_datasource),
                                                                                            _outDatasetName)
    except:
