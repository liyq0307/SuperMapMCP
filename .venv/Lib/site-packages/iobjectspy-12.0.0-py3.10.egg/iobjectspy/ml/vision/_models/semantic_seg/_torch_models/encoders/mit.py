...
class MixVisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
                 ...
                 depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1], use_chk_=False, **kwargs):
        super().__init__()
...
class MITEncoder(MixVisionTransformer, EncoderMixin):
...
mit_encoders = {
    "mit-b0": {
        ...
        "pretrained_settings": {
            "imagenet": {
                "url": "https://download.pytorch.org/models/mit_b0.pth",
                "input_space": "RGB",
    ...
    "mit-b1": {
        ...
        "pretrained_settings": {
            "imagenet": {
                "url": "https://download.pytorch.org/models/mit_b1.pth",
                "input_space": "RGB",
                "input_size": [3, 224, 224],
                "input_range": [0, 1],
                "mean": [0.485, 0.456, 0.406],
    ...
    "mit-b2": {
        ...
        "pretrained_settings": {
            "imagenet": {
                "url": "https://download.pytorch.org/models/mit_b2.pth",
                "input_space": "RGB",
                "input_size": [3, 224, 224],
                "input_range": [0, 1],
                "mean": [0.485, 0.456, 0.406],
    ...
    "mit-b3": {
        ...
        "pretrained_settings": {
            "imagenet": {
                "url": "https://download.pytorch.org/models/mit_b3.pth",
                "input_space": "RGB",
                "input_size": [3, 224, 224],
                "input_range": [0, 1],
                "mean": [0.485, 0.456, 0.406],
    ...
    "mit-b4": {
        ...
        "pretrained_settings": {
            "imagenet": {
                "url": "https://download.pytorch.org/models/mit_b4.pth",
                "input_space": "RGB",
                "input_size": [3, 224, 224],
                "input_range": [0, 1],
                "mean": [0.485, 0.456, 0.406],
    ...
    "mit-b5": {
        ...
        "pretrained_settings": {
            "imagenet": {
                "url": "https://download.pytorch.org/models/mit_b5.pth",
                "input_space": "RGB",
                "input_size": [3, 224, 224],
                "input_range": [0, 1],
                "mean": [0.485, 0.456, 0.406],
    ...
    "mit-large": {
        ...
        "pretrained_settings": {
            "imagenet": {
                "url": "https://download.pytorch.org/models/mit_large.pth",
                "input_space": "RGB",
                "input_size": [3, 224, 224],
                "input_range": [0, 1],
                "mean": [0.485, 0.456, 0.406],
    ...
    "mit-huge": {
        ...
        "pretrained_settings": {
            "imagenet": {
                "url": "https://download.pytorch.org/models/mit_huge.pth",
                "input_space": "RGB",
                "input_size": [3, 224, 224],
                "input_range": [0, 1],
                "mean": [0.485, 0.456, 0.406],
