...
class SegformerLora(SupervisedFineTune, nn.Module):
    def __init__(self, segformer_model, finetune_module_type):
        nn.Module.__init__(self)
        SupervisedFineTune.__init__(self, segformer_model, finetune_module_type)
    ...
    def perpare_finetune(self, rank=4, lora_layer=None):
        ...
        if lora_layer:
            ...
            #     range(len(self.model.encoder.block1) +
            #           len(self.model.encoder.block2) +
            #           len(self.model.encoder.block3) +
            #           len(self.model.encoder.block4)))
