...
class DLinknetTrainer(SegTorchTrainer):
...
class DLinknetEstimation(SegTorchEstimation):
    def __init__(self, model_path, config, gpus, batch_size, test_aug=False, **kwargs):
        super(DLinknetEstimation, self).__init__(model_path, config, gpus, batch_size, test_aug, **kwargs)
