...
class CustomLoggerHook(Hook):
    ...
    def after_train_iter(self,
        ...
        runner.visualizer.add_scalars('train', tag, step=runner.iter + 1, file_path=self.json_log_path)
    ...
    def after_val_epoch(self,
        ...
        if self.log_metric_by_epoch:
            ...
            if isinstance(runner._train_loop, dict) or runner._train_loop is None:
                ...
                epoch = runner.epoch
            runner.visualizer.add_scalars('val', tag, step=epoch, file_path=self.json_log_path)
        else:
            if isinstance(runner._train_loop, dict) or runner._train_loop is None:
                iter = 0
            else:
                iter = runner.iter
            runner.visualizer.add_scalars('val', tag, step=iter, file_path=self.json_log_path)
