...
class SfnetTrainer(SegTorchTrainer):
...
class SiamSfnetTrainer(SegTorchTrainer):
    def __init__(self):
        super().__init__()
        self.callbacks = []
        self.loss = []
        ...
        self.val_loss = []
        self.val_acc = []
        self.model_architecture = 'siamsfnet'
...
class SfnetEstimation(SegTorchEstimation):
    def __init__(self, model_path, config, gpus, batch_size, test_aug=False, **kwargs):
        super(SfnetEstimation, self).__init__(model_path, config, gpus, batch_size, test_aug, **kwargs)
        pass


class SiamSfnetEstimation(SegTorchEstimation_CD):
    def __init__(self, model_path, config, gpus, batch_size, test_aug=False, **kwargs):
        super(SiamSfnetEstimation, self).__init__(model_path, config, gpus, batch_size, test_aug, **kwargs)
        pass
