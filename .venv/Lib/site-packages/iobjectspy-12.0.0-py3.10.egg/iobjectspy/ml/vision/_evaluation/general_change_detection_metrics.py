...
def general_change_detection_all(inference_data, ground_truth_data, inference_class_value_field,
...
def general_change_detection_iou(inference_data, ground_truth_data, inference_class_value_field,
                                 ground_truth_class_value_field,
                                 out_data, out_data_name):
    """
...
def general_change_detection_pixel_acc(inference_data, ground_truth_data, inference_class_value_field,
                                       ground_truth_class_value_field,
                                       out_data, out_data_name):
    """
        基于输入的真实标签数据和预测标签数据计算结果的IOU得分，支持影像和影像数据计算，矢量和矢量数据计算
...
def general_change_detection_f1(inference_data, ground_truth_data, inference_class_value_field,
                                ground_truth_class_value_field,
                                out_data, out_data_name):
    """
        基于输入的真实标签数据和预测标签数据计算结果的IOU得分，支持影像和影像数据计算，矢量和矢量数据计算
...
def general_change_detection_kappa(inference_data, ground_truth_data, inference_class_value_field,
                                   ground_truth_class_value_field,
                                   out_data, out_data_name):
    """
        基于输入的真实标签数据和预测标签数据计算结果的IOU得分，支持影像和影像数据计算，矢量和矢量数据计算
...
def general_change_detection_confusion_matrix(inference_data, ground_truth_data, inference_class_value_field,
                                              ground_truth_class_value_field,
                                              out_data, out_data_name):
    """
        基于输入的真实标签数据和预测标签数据计算结果的IOU得分，支持影像和影像数据计算，矢量和矢量数据计算
