...
def object_detection_all(inference_data, ground_truth_data,
...
def object_detection_map(inference_data, ground_truth_data,
                         inference_class_value_field='category', ground_truth_class_value_field=None, out_data='',out_data_name='',categorys_dict=None,
                         iou_thr=0.5,
                         nproc=4):
    """
...
def object_detection_ap(inference_data, ground_truth_data,
                         inference_class_value_field='category', ground_truth_class_value_field=None, out_data='',out_data_name='',categorys_dict=None,
                         iou_thr=0.5,
                         nproc=4):
    """
...
def object_detection_precision(inference_data, ground_truth_data,
                             inference_class_value_field='category', ground_truth_class_value_field=None, out_data='',out_data_name='',categorys_dict=None,
                             iou_thr=0.5,
                             nproc=4):
    """
...
def object_detection_recall(inference_data, ground_truth_data,
                             inference_class_value_field='category', ground_truth_class_value_field=None, out_data='',out_data_name='',categorys_dict=None,
                             iou_thr=0.5,
                             nproc=4):
    """
...
def object_detection_f1(inference_data, ground_truth_data,
                         inference_class_value_field='category', ground_truth_class_value_field=None, out_data='',out_data_name='',categorys_dict=None,
                         iou_thr=0.5,
                         nproc=4):
    """
