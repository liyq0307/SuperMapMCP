...
class BinaryClassification:
    ...
    def infer(self, input_data, out_data, out_dataset_name, offset, result_type, infer_region, **kwargs):
        ...
        if isinstance(result, str):
            print(
                'The result of image \'{}\' have been saved to \'{}\'!'.format(
    ...
    def _dlinknet_pytorch_load_model(self):
        from .._models.semantic_seg.dlinknet_torch import DLinknetEstimation
        self.estimation = DLinknetEstimation(
