...
import_bil = supermap.import_bil
import_bip = supermap.import_bip
import_bsq = supermap.import_bsq
import_orange_tab = supermap.import_orange_tab
import_grib = supermap.import_grib
import_egc = supermap.import_egc
import_raw = supermap.import_raw
import_vrt = supermap.import_vrt
import_gpkg = supermap.import_gpkg
import_gbdem = supermap.import_gbdem
import_lidar = supermap.import_lidar
import_gjb = supermap.import_gjb
import_tems_clutter = supermap.import_tems_clutter
import_tems_vector = supermap.import_tems_vector
import_tems_building_vector = supermap.import_tems_building_vector
import_file_gdb_vector = supermap.import_file_gdb_vector
import_personal_gdb_vector = supermap.import_personal_gdb_vector
import_tems_text_labels = supermap.import_tems_text_labels
...
export_to_egc = supermap.export_to_egc
export_to_gjb = supermap.export_to_gjb
export_to_tems_vector = supermap.export_to_tems_vector
export_to_tems_clutter = supermap.export_to_tems_clutter
export_to_tems_text_labels = supermap.export_to_tems_text_labels
export_to_tems_building_vector = supermap.export_to_tems_building_vector
export_to_file_gdb_vector = supermap.export_to_file_gdb_vector
export_to_personal_gdb_vector = supermap.export_to_personal_gdb_vector

__all__ = ['import_shape', 'import_dbf', 'import_csv', 'import_mapgis', 'import_aibingrid', 'import_bmp',
           'import_dgn', 'import_dwg', 'import_dxf', 'import_e00', 'import_ecw',
           'import_geojson', 'import_gif', 'import_grd', 'import_img', 'import_jp2',
           'import_jpg', 'import_kml', 'import_kmz', 'import_mif', 'import_mrsid', 'import_osm', 'import_png',
           'import_simplejson', 'import_sit', 'import_tab', 'import_tif', 'import_usgsdem', 'import_vct',
           'import_bil', 'import_bip', 'import_orange_tab',
           ...
           'export_to_bmp', 'export_to_gif', 'export_to_grd', 'export_to_img', 'export_to_jpg',
           'export_to_png', 'export_to_sit', 'export_to_tif', 'export_to_csv', 'export_to_dbf',
           'export_to_dwg', 'export_to_dxf',
           'export_to_e00', 'export_to_kml', 'export_to_kmz', 'export_to_geojson', 'export_to_mif',
           'export_to_shape', 'export_to_simplejson', 'export_to_tab', 'export_to_vct',
           'export_to_egc', 'export_to_gjb',
