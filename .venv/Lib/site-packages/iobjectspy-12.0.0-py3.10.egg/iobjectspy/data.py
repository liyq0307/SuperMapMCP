...
create_mem_datasource = supermap.create_mem_datasource
...
zoom_geometry = supermap.zoom_geometry
divide_polygon = supermap.divide_polygon

GeoConstructiveSolid = supermap.GeoConstructiveSolid
CSGNode = supermap.CSGNode
CSGEntity = supermap.CSGEntity
CSGBooleanNode = supermap.CSGBooleanNode
CSGSimpleNode = supermap.CSGSimpleNode
Box = supermap.Box
Sphere = supermap.Sphere
Cylinder = supermap.Cylinder
Cone = supermap.Cone
Ellipsoid = supermap.Ellipsoid
Torus = supermap.Torus
TruncatedCone = supermap.TruncatedCone
Table3D = supermap.Table3D
Wedge = supermap.Wedge
Pyramid = supermap.Pyramid
EllipticRing = supermap.EllipticRing
RectangularRing = supermap.RectangularRing
SlopedCylinder = supermap.SlopedCylinder
BendingCylinder = supermap.BendingCylinder

__all__ = ['DatasourceConnectionInfo', 'Datasource', 'Dataset', 'DatasetVector', 'DatasetVectorInfo',
           'DatasetImageInfo', 'DatasetGridInfo',
           'DatasetImage', 'DatasetGrid', 'DatasetTopology', 'DatasetMosaic', 'DatasetVolume',
           ...
           'ObjectDisposedError', 'DatasourceCreatedFailedError', 'FieldInfo', 'Point2D', 'Point3D', 'PointM',
           'Rectangle',
           'Geometry', 'GeoPoint', 'GeoPoint3D', 'GeoLine', 'GeoLineM', 'GeoRegion', 'TextPart', 'GeoText', 'TextStyle',
           ...
           'close_datasource', 'list_datasources', 'create_datasource', 'create_mem_datasource',
           'dataset_dim2_to_dim3', 'dataset_dim3_to_dim2',
           ...
           'zoom_geometry', 'divide_polygon', 'CSGNode', 'CSGEntity', 'CSGBooleanNode', 'CSGSimpleNode',
           'Box', 'Sphere', 'Cylinder', 'Cone', 'Ellipsoid', 'Torus', 'TruncatedCone', 'Table3D', 'Wedge', 'Pyramid',
           'EllipticRing', 'RectangularRing', 'SlopedCylinder', 'BendingCylinder', 'GeoConstructiveSolid']
